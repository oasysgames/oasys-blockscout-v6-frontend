...
const DEFAULT_TEMPLATE = 'Oasys explorer allows you to explore and search for transactions, addresses, tokens, prices and other activities taking place on Oasys. ';
