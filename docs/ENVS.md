...
| NEXT_PUBLIC_MENU_BRIDGE_VISIBLE | `boolean` | Set to true to show bridged Token | - | - | `false` | v6.7.x+ |
| NEXT_PUBLIC_MENU_BRIDGE_URL | `string` | Set to bridge url to in the navigation  | - | - | `false` | v6.7.x+ |
